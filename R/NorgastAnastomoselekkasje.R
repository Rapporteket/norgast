...
NorgastAnastomoselekkasje <- function(RegData = RegData, datoFra = "2014-01-01", datoTil = "2050-12-31",
  ...
  grtxt <- c(
    "Kolonreseksjoner, ny anastomose", "Kolonreseksjoner, øvrige", "Rektumreseksjoner, ny anastomose",
  ...
  NorgastUtvalg <- NorgastUtvalg(
    RegData = RegData, datoFra = datoFra, datoTil = datoTil, minald = minald, maxald = maxald,
  ...
  ###  Lage tabeller #####################################################################
  Tabell1 <- data.frame(
    Operasjonsgruppe = grtxt, N_lokal = numeric(8), RateAnastomoselekkasje_lokal = numeric(8),
  ...
  Tabell2 <- data.frame(
    Operasjonsgruppe = c("Rektumreseksjoner, ny anastomose", "\\quad Uten avlastende stomi", "\\quad Med avlastende stomi"),
  ...
  Tabell3 <- data.frame(
    Operasjonsgruppe = c(
      "Rektumreseksjon, ny anastomose", "\\quad Ingen forbehandling", "\\quad Enhver forbehandling",
