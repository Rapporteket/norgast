  ...
  shiny::tagList(
    ...
    shiny::navbarPage(
      ...
      shiny::tabPanel(
        ...
        shiny::h4("Når du velger ", strong("Last ned samledokument"), " genereres
                  en samlerapport bestående av figurer og tabeller.", align='center'),
      ...
      shiny::tabPanel(
        ...
        det være små avvik i antall forløp som inkluderes i datadump på Rapporteket
                  sammenlignet med datadump hentet fra registerets qreg-løsning.", align='center'),
        shiny::br(),
        shiny::br(),
