...
############# OBS: MIDLERTIDIG ############################################
############# OBS: MIDLERTIDIG ############################################
graaUt_kolon <- graaUt_kolon[!(graaUt_kolon %in% c("OUS-Radiumhospitalet", "Sykehuset Levanger"))]
...
figfolder <- "~/mydata/norgast/fig_aarsrapp2023/kolon/"
...
outfile <- 'AccordionGrad_utvalg_torunn_ecog01.pdf'
outfile <- paste0(figfolder, outfile)
NorgastFigAndelStabelGrVar(
  RegData, valgtVar='AccordionGrad_drenasje', op_gruppe=c(1,11),
  hastegrad=1, outfile=outfile, Ngrense=10, malign = 0, lavDG = graaUt_kolon,
...
outfile <- 'AccordionGrad_benign_torunn.pdf'
outfile <- paste0(figfolder, outfile)
FigAndeler(
  RegData, valgtVar='AccordionGrad', enhetsUtvalg=0, op_gruppe=op_gruppe,
...
valgtVar <- 'Anastomoselekkasje'
outfile <- 'Anastomoselekkasje_benign_torunn.pdf'
outfile <- paste0(figfolder, outfile)
norgastIndikator_rapporteket(
  RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width,
  height=height, decreasing=T, terskel=terskel, minstekrav = 6, maal = 4,
  ...
  pktStr=pktStr, legPlass='topright', minstekravTxt=minstekravTxt, maalTxt=maalTxt,
  graaUt=graaUt, whoEcog= c('0', '1'), inkl_konf=inkl_konf, op_gruppe=op_gruppe,
  datoFra=datoFra, datoTil=datoTil, hastegrad=1, malign=0,
  prikktall = FALSE, pst_kolonne = TRUE,
  icd_kode = c("K500", "K501", "K508", "K509", "K511", "K512", "K513", "K514",
               "K515", "K518", "K519"))
if (annet_format_ut) {
...
outfile <- "Anastomoselekkasje_benign_torunn_gruppert_kolitt.pdf"
outfile <- paste0(figfolder, outfile)
norgastIndikator_nasjonal(
  RegData = RegDataAll, valgtVar = "Anastomoselekkasje", outfile=outfile, tittel=tittel, width=width,
  ...
  lavDGtekst = dg_tekst, inkl_konf=inkl_konf, ny_anastomose = 1,
  op_gruppe=op_gruppe, datoFra=datoFra, datoTil=datoTil, whoEcog = 0:1,
...
outfile <- 'nystomi_benign_kolon_torunn.pdf'
outfile <- paste0(figfolder, outfile)
valgtVar <- 'NyStomi'
norgastIndikator_rapporteket(
  RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width,
  ...
  maalTxt=maalTxt, graaUt=graaUt, lavDG = graaUt_kolon, lavDGtekst = dg_tekst,
  inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra='2018-05-01', datoTil=datoTil,
  hastegrad_hybrid=99, malign=0, hastegrad = 1, whoEcog = c(0,1),
  icd_kode = c("K500", "K501", "K508", "K509", "K511", "K512", "K513", "K514",
               "K515", "K518", "K519"))
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
...
outfile <- "nystomi_benign_nyanastomose_torunn_gruppert_kolitt.pdf"
outfile <- paste0(figfolder, outfile)
norgastIndikator_nasjonal(
  RegData = RegDataAll, valgtVar = "NyStomi", outfile=outfile, tittel=tittel, width=width,
  height=height, decreasing=decreasing, terskel=terskel, minstekrav = minstekrav,
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}AccordionGrad_utvalg_torunn_ecog01.pdf}
\caption{AccordionGrad\_utvalg\_torunn\_ecog01.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}AccordionGrad_benign_torunn.pdf}
\caption{AccordionGrad\_benign\_torunn.pdf}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}Anastomoselekkasje_benign_torunn.pdf}
\caption{Anastomoselekkasje\_benign\_torunn.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}Anastomoselekkasje_benign_torunn_gruppert_kolitt.pdf}
\caption{Anastomoselekkasje\_benign\_torunn\_gruppert\_kolitt.pdf}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}nystomi_benign_kolon_torunn.pdf}
\caption{nystomi\_benign\_kolon\_torunn.pdf}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}nystomi_benign_nyanastomose_torunn_gruppert_kolitt.pdf}
\caption{nystomi\_benign\_nyanastomose\_torunn\_gruppert\_kolitt.pdf}
\end{figure}
...
norgast::norgastAndelGruppert2Gr(valgtVar="Anastomoselekkasje", outfile = outfile,
                                 ...
                                 RegData = aux, datoFra="2021-01-01",
                                 datoTil="2023-12-31",op_gruppe=2,
...
#   lavDGtekst = dg_tekst, inkl_konf=inkl_konf, ny_anastomose = 1,
#   op_gruppe=op_gruppe, datoFra=datoFra, datoTil=datoTil, #whoEcog = 0:1,
#   hastegrad=hastegrad, malign=1, Grvar = "AvstandAnalVerge_kat2", kun_ferdigstilte = T)
# if (annet_format_ut) {
#   norgastIndikator_nasjonal(
#     RegData = RegDataAll, valgtVar = "NyStomi", outfile=outfile, tittel=tittel, width=width,
#     height=height, decreasing=decreasing, terskel=terskel, minstekrav = minstekrav,
...
norgast::norgastAndelGruppert2Gr(valgtVar="NyStomi", outfile = outfile,
                                 ...
                                 datoTil="2023-12-31",op_gruppe=2,
                                 malign=1, ytxt = "Avstand analkanten",
                                 hastegrad = 1, whoEcog = 0:1, ny_anastomose =1)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  norgast::norgastAndelGruppert2Gr(valgtVar="NyStomi", outfile = outfile,
                                 Grvar1 = "AvstandAnalVerge_kat2", Grvar2 = "Robot",
...
outfile <- 'anastomoselekk_gruppert_stomi_m_robot.pdf'
outfile <- paste0(figfolder, outfile)
valgtVar <- 'Anastomoselekkasje'
norgastIndikator_gruppert(
  RegData=aux, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width,
  height=900, decreasing=T, terskel=terskel, minstekrav = NA, maal = NA,
  skriftStr=skriftStr, lavDG = graaUt_rektum, lavDGtekst = dg_tekst, robotassiastanse = 1,
  pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt,
  graaUt=graaUt, inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra=datoFra, hastegrad = 1,
  datoTil=datoTil, hastegrad_hybrid=hastegrad_hybrid, malign=1, ny_anastomose=1,
  kun_ferdigstilte = T, prikktall = FALSE, Grvar2 = "NyStomi_faktor", whoEcog = 0:1)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  norgastIndikator_gruppert(
    RegData=aux, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width,
...
outfile <- 'anastomoselekk_gruppert_stomi_u_robot.pdf'
outfile <- paste0(figfolder, outfile)
valgtVar <- 'Anastomoselekkasje'
norgastIndikator_gruppert(
  RegData=aux, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width,
  height=900, decreasing=T, terskel=terskel, minstekrav = NA, maal = NA,
  skriftStr=skriftStr, lavDG = graaUt_rektum, lavDGtekst = dg_tekst, robotassiastanse = 0,
  pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt,
  graaUt=graaUt, inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra=datoFra, hastegrad = 1,
  datoTil=datoTil, hastegrad_hybrid=hastegrad_hybrid, malign=1, ny_anastomose=1,
  kun_ferdigstilte = T, prikktall = FALSE, Grvar2 = "NyStomi_faktor", whoEcog = 0:1)
...
outfile <- 'anastomoselekk_gruppert_robot_u_stomi.pdf'
outfile <- paste0(figfolder, outfile)
valgtVar <- 'Anastomoselekkasje'
norgastIndikator_gruppert(
  RegData=aux, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width,
  height=900, decreasing=T, terskel=terskel, minstekrav = NA, maal = NA,
  skriftStr=skriftStr, lavDG = graaUt_rektum, lavDGtekst = dg_tekst, ny_stomi = 0,
  pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt,
  graaUt=graaUt, inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra=datoFra,hastegrad = 1,
  datoTil=datoTil, hastegrad_hybrid=hastegrad_hybrid, malign=1, ny_anastomose=1,
  kun_ferdigstilte = T, prikktall = FALSE, Grvar2 = "Tilgang_utvidet", whoEcog = 0:1)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  norgastIndikator_gruppert(
    RegData=aux, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width,
...
outfile <- 'anastomoselekk_gruppert_robot_m_stomi.pdf'
outfile <- paste0(figfolder, outfile)
valgtVar <- 'Anastomoselekkasje'
norgastIndikator_gruppert(
  RegData=aux, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width,
  height=900, decreasing=T, terskel=terskel, minstekrav = NA, maal = NA,
  skriftStr=skriftStr, lavDG = graaUt_rektum, lavDGtekst = dg_tekst, ny_stomi = 1,
  pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt,
  graaUt=graaUt, inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra=datoFra, hastegrad = 1,
  datoTil=datoTil, hastegrad_hybrid=hastegrad_hybrid, malign=1, ny_anastomose=1,
  kun_ferdigstilte = T, prikktall = FALSE, Grvar2 = "Tilgang_utvidet", whoEcog = 0:1)
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}anastomoselekk_gruppert_stomi_m_robot.pdf}
\caption{anastomoselekk\_gruppert\_stomi\_m\_robot.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}anastomoselekk_gruppert_stomi_u_robot.pdf}
\caption{anastomoselekk\_gruppert\_stomi\_u\_robot.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}anastomoselekk_gruppert_robot_m_stomi.pdf}
\caption{anastomoselekk\_gruppert\_robot\_m\_stomi.pdf}
\end{figure}


\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}anastomoselekk_gruppert_robot_u_stomi.pdf}
\caption{anastomoselekk\_gruppert\_robot\_u\_stomi.pdf}
\end{figure}
