...
norgastFigAntRegTid(RegDataAll, outfile=outfile, tittel=tittel, width=width, height=height,
                        ...
                        inkl_konf=inkl_konf, reseksjonsGr=reseksjonsGr, datoFra=datoFra, datoTil=datoTil, elektiv=elektiv, malign=malign)
if (annet_format_ut) {
...
malign <- 0
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='Tilgang', reseksjonsGr=reseksjonsGr, elektiv=1, outfile=outfile, reshID=reshID, Ngrense=10, malign = malign)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='Tilgang', reseksjonsGr=reseksjonsGr, elektiv=1, outfile=outfile, reshID=reshID, Ngrense=10, malign = malign)
}
...
# NorgastFigAndelStabelKunNasjonal(RegData, valgtVar='Tilgang', reseksjonsGr=reseksjonsGr, elektiv=0, outfile=outfile, reshID=reshID)
FigAndeler(RegData, valgtVar='Tilgang', enhetsUtvalg=0, op_gruppe=op_gruppe, elektiv=0, outfile=outfile, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  FigAndeler(RegData, valgtVar='Tilgang', enhetsUtvalg=0, reseksjonsGr=reseksjonsGr, elektiv=0, outfile=outfile, reshID=reshID)
}

malign <- 0
outfile <- 'AccordionGrad_elektiv_benign.pdf'
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='AccordionGrad', reseksjonsGr=reseksjonsGr, elektiv=1, outfile=outfile, reshID=reshID, Ngrense=10, malign=malign)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='AccordionGrad', reseksjonsGr=reseksjonsGr, elektiv=1, outfile=outfile, reshID=reshID, Ngrense=10, malign=malign)
}
...
# NorgastFigAndelStabelKunNasjonal(RegData, valgtVar='AccordionGrad', reseksjonsGr=reseksjonsGr, elektiv=0, outfile=outfile, reshID=reshID)
FigAndeler(RegData, valgtVar='AccordionGrad', enhetsUtvalg=0, op_gruppe=op_gruppe, elektiv=0, outfile=outfile, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  FigAndeler(RegData, valgtVar='AccordionGrad', enhetsUtvalg=0, reseksjonsGr=reseksjonsGr, elektiv=0, outfile=outfile, reshID=reshID)
}
...
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='AccordionGrad', reseksjonsGr=reseksjonsGr, outfile=outfile, Ngrense=terskel, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='AccordionGrad', reseksjonsGr=reseksjonsGr, outfile=outfile, Ngrense=terskel, reshID=reshID)
}
...
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='Tilgang', reseksjonsGr=reseksjonsGr, outfile=outfile, Ngrense=terskel, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='Tilgang', reseksjonsGr=reseksjonsGr, outfile=outfile, Ngrense=terskel, reshID=reshID)
}
...
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='ThoraxTilgang', reseksjonsGr=reseksjonsGr, outfile=outfile, Ngrense=terskel, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='ThoraxTilgang', reseksjonsGr=reseksjonsGr, outfile=outfile, Ngrense=terskel, reshID=reshID)
}
...
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='AccordionGrad', reseksjonsGr=reseksjonsGr, outfile=outfile, Ngrense=5, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='AccordionGrad', reseksjonsGr=reseksjonsGr, outfile=outfile, Ngrense=5, reshID=reshID)
}
...
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='Tilgang', reseksjonsGr=reseksjonsGr, outfile=outfile, Ngrense=5, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='Tilgang', reseksjonsGr=reseksjonsGr, outfile=outfile, Ngrense=5, reshID=reshID)
}
...
# NorgastFigAndelerGrVar(RegData=RegData, valgtVar='ReLapNarkose', reseksjonsGr=reseksjonsGr, outfile=outfile, reshID=reshID, Ngrense=5, inkl_konf=T)
...
if (annet_format_ut) {
  ...
  norgastFigAndelGrVarTid(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
                        decreasing=decreasing, terskel=terskel, minstekrav = minstekrav, maal = maal, skriftStr=skriftStr,
                        pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt,
                        inkl_konf=inkl_konf, reseksjonsGr=reseksjonsGr, datoFra=datoFra, datoTil=datoTil,
                        elektiv=elektiv, malign=malign)
}
@
