...
% LEGG TIL ELEKTIV ALLE STEDER HVOR DET I DAG ER "INNENFOR NORMALARBEIDSTID"
...
RegData <- read.table('I:/norgast/AlleVarNum2020-03-11 14-52-26.txt', header=TRUE, sep=";", encoding = 'UFT-8')
ForlopData <- read.table('I:/norgast/ForlopsOversikt2020-03-11 14-52-26.txt', header=TRUE, sep=";", encoding = 'UFT-8')
...
# FigAndeler(RegData, valgtVar='Sykehusnavn', op_gruppe='', outfile=outfile, reshID=reshID, enhetsUtvalg=0)
...
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  FigAndeler(RegDataAll, valgtVar='Sykehusnavn', op_gruppe='', outfile=outfile, datoFra='2014-01-01', datoTil=datoTil, reshID=reshID, enhetsUtvalg=0)
}
...
malign <- 0
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='Tilgang', op_gruppe=op_gruppe, elektiv=1, outfile=outfile, Ngrense=10, malign = malign)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='Tilgang', op_gruppe=op_gruppe, elektiv=1, outfile=outfile, reshID=reshID, Ngrense=10, malign = malign)
}


outfile <- 'Tilgang_elektiv_benign_aar.pdf'
valgtVar <- 'LapTilgang2'
norgastFigAndelGrVarTid(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
# NorgastFigAndelStabelKunNasjonal(RegData, valgtVar='Tilgang', op_gruppe=op_gruppe, elektiv=0, outfile=outfile, reshID=reshID)
...
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='AccordionGrad', op_gruppe=op_gruppe, elektiv=1, outfile=outfile, reshID=reshID, Ngrense=10, malign=malign)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='AccordionGrad', op_gruppe=op_gruppe, elektiv=1, outfile=outfile, reshID=reshID, Ngrense=10, malign=malign)
}
...
# NorgastFigAndelStabelKunNasjonal(RegData, valgtVar='AccordionGrad', op_gruppe=op_gruppe, elektiv=0, outfile=outfile, reshID=reshID)
...
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, reshID=reshID)
}
...
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, reshID=reshID)
}
...
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='ThoraxTilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='ThoraxTilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, reshID=reshID)
}
...
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=5, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=5, reshID=reshID)
}
...
NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=5, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVarAarsrapp(RegData, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=5, reshID=reshID)
}
...
# NorgastFigAndelerGrVar(RegData=RegData, valgtVar='ReLapNarkose', op_gruppe='JJB', outfile=outfile, reshID=reshID, Ngrense=5, inkl_konf=T)
valgtVar <- 'ReLapNarkose'
norgastFigAndelGrVarTid(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
                        decreasing=decreasing, terskel=terskel, minstekrav = minstekrav, maal = maal, skriftStr=skriftStr,
                        pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt,
...
# NorgastFigAndelerGrVar(RegData=RegData, valgtVar='ReLapNarkose', op_gruppe=op_gruppe, outfile=outfile, reshID=reshID, Ngrense=5, inkl_konf=T)
...
reseksjonsGr <- 'JLC[0-2][0-9]|JLC[4-9][0-9]|JLC[3][2-9]'
op_gruppe <- 7
...
tittel <- 'Andel sårruptur blant åpne og konverterte inngrep'
norgastFigAndelGrVarTid(RegDataAll[which(RegDataAll$Tilgang %in% c(1,3)), ], valgtVar = valgtVar, outfile=outfile,
                        tittel=tittel, width=width, height=height,
                        decreasing=decreasing, terskel=terskel, minstekrav = minstekrav, maal = maal, skriftStr=skriftStr,
                        pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt,
                        inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra=datoFra, datoTil=datoTil, elektiv=elektiv, malign=malign)
if (annet_format_ut) {
