...
write.csv2(Tabell, paste0(tabfolder, "reop_osofagus.csv"), row.names = T, fileEncoding = 'Latin1')
...
write.csv2(Tabell, paste0(tabfolder, "reop_ventrikkel.csv"), row.names = T, fileEncoding = 'Latin1')
print(xtable::xtable(Tabell, digits=c(0,0,0,rep(1, ncol(Tabell)-2))),
      floating=FALSE,
      hline.after=NULL,
      align=c('l', 'l', rep('r', ncol(Tabell)-1)),
