...
tmpdata <- RegDataAll[!(RegDataAll$Sykehusnavn %in% c("VV−Drammen", "VV−Bærum", "UNN−Harstad", "Stavanger", "St.Olavs",
                                                    "SS−Kristiansand", "OUS−Rikshospitalet", "OUS−Rikshospitalet",
                                                    "HS−Mo i Rana", "HB−Voss", "Ahus")), ]
