...
\title{Figurer og tabeller for årsrapport NORGAST 2024 - Generell del}
\author{NORGAST}
...
graaUt_alle <- DG$Sykehusnavn[DG$DG < dgterskel]
# graaUt_alle <- ""
...
annet_format_ut <- T
ut_format <- 'svg'
figfolder <- "C:/Users/kth200/OneDrive - Helse Nord RHF/Dokumenter/regdata/norgast/aarsrapp2024/generell/"
if (!dir.exists(figfolder)) {
  dir.create(figfolder)
}
tabfolder <- "C:/Users/kth200/OneDrive - Helse Nord RHF/Dokumenter/regdata/norgast/aarsrapp2024/generell/"
...
mapping <- read.csv2("~/regdata/norgast/map_hf.csv", fileEncoding = "Latin1")
aux <- RegDataAll |>
