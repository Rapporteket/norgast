...
write.csv2(Tabell, paste0(tabfolder, "ant_reg_alle.csv"), row.names = T, fileEncoding = 'Latin1')
...
write.csv2(Tabell, paste0(tabfolder, "ant_reg_oblig.csv"), row.names = T, fileEncoding = 'Latin1')
@
...
write.csv2(Tabell, paste0(tabfolder, "RegistrenrendeAvd.csv"), row.names = T, fileEncoding = 'Latin1')
@
