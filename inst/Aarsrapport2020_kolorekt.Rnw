...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/ViktigsteFunn_kolon_elektiv.pdf'
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/Tilgang_elektiv_malign.pdf'
malign <- 1
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/Tilgang_elektiv_malign_aar.pdf'
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/Tilgang_elektiv_malign_ecog_0_1.pdf'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/AccordionGrad_elektiv_benign.pdf'
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/KumAcc_elektiv_benign_aar.pdf'
valgtVar <- 'KumAcc'
tittel <- ''
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/AccordionGrad_elektiv_malign.pdf'
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/KumAcc_elektiv_malign_aar.pdf'
valgtVar <- 'KumAcc'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
                     decreasing=decreasing, terskel=terskel, minstekrav = NA, maal = NA, skriftStr=skriftStr,
                     pktStr=pktStr, legPlass='topleft', minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt, lavDG = graaUt_kolon,
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/AccordionGrad_ohjelp.pdf'
...
malign <- 1
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/ReLapNarkose_malign_ecog0_1_aar.pdf'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/konv_rate_malign_ecog0_1_aar.pdf'
valgtVar <- 'konv_rate'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/Anastomoselekkasje_malign_ecog0_1aar.pdf'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/mortalitet90_kolon_aar.pdf'
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/mortalitet90_kolon_aar_refpas.pdf'
valgtVar <- 'mortalitet90'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/hastegrad_ny_kolon_aar.pdf'
valgtVar <- 'Hastegrad'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/ohjelp_kveld_kolon_aar.pdf'
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/ViktigsteFunn_kolon_elektiv.pdf}
\caption{ViktigsteFunn\_kolon\_elektiv.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/Tilgang_elektiv_malign.pdf}
\caption{Tilgang\_elektiv\_malign.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/Tilgang_elektiv_malign_aar.pdf}
\caption{Tilgang\_elektiv\_malign\_aar.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/Tilgang_elektiv_malign_ecog_0_1.pdf}
\caption{Tilgang\_elektiv\_malign\_ecog\_0\_1.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/AccordionGrad_elektiv_benign.pdf}
\caption{AccordionGrad\_elektiv\_benign.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/KumAcc_elektiv_benign_aar.pdf}
\caption{KumAcc\_elektiv\_benign\_aar.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/AccordionGrad_elektiv_malign.pdf} % 10
\caption{AccordionGrad\_elektiv\_malign.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/KumAcc_elektiv_malign_aar.pdf} % 11
\caption{KumAcc\_elektiv\_malign\_aar.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/AccordionGrad_ohjelp.pdf} % 12
\caption{AccordionGrad\_ohjelp.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/ReLapNarkose_malign_ecog0_1_aar.pdf}
\caption{ReLapNarkose\_malign\_ecog0\_1\_aar.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/konv_rate_malign_ecog0_1_aar.pdf}
\caption{konv\_rate\_malign\_ecog0\_1\_aar.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/Anastomoselekkasje_malign_ecog0_1aar.pdf}
\caption{Anastomoselekkasje\_malign\_ecog0\_1aar.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/mortalitet90_kolon_aar.pdf}
\caption{mortalitet90\_kolon\_aar.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/mortalitet90_kolon_aar_refpas.pdf}
\caption{mortalitet90\_kolon\_aar\_refpas.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/hastegrad_ny_kolon_aar.pdf}
\caption{hastegrad\_ny\_kolon\_aar.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/ohjelp_kveld_kolon_aar.pdf}
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/AvstandAnalVerge_kat_rekt.pdf'
...
valgtVar <- 'LapTilgang2'
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/Tilgang_rekt_malign_ecog_0_1.pdf'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
valgtVar <- 'ReLapNarkose'
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/ReLapNarkose_rekt_malign_ecog_0_1.pdf'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
valgtVar <- 'Anastomoselekkasje'
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/Anastomoselekkasje_rekt_malign_ecog_0_1.pdf'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/konv_rate_rektum_malign_ecog0_1.pdf'
valgtVar <- 'konv_rate'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/mortalitet90_rektum_aar.pdf'
valgtVar <- 'mortalitet90'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/AccordionGrad_rekt.pdf'
...
outfile <- '/home/rstudio/norgast/inst/fig_aarsrapp_2020/KumAcc_rekt_aar.pdf'
valgtVar <- 'KumAcc'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/Tilgang_rekt_malign_ecog_0_1.pdf}
\caption{Tilgang\_rekt\_malign\_ecog\_0\_1.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/ReLapNarkose_rekt_malign_ecog_0_1.pdf}
\caption{ReLapNarkose\_rekt\_malign\_ecog\_0\_1.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/Anastomoselekkasje_rekt_malign_ecog_0_1.pdf}
\caption{Anastomoselekkasje\_rekt\_malign\_ecog\_0\_1.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/konv_rate_rektum_malign_ecog0_1.pdf}
\caption{konv\_rate\_rektum\_malign\_ecog0\_1.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/AccordionGrad_rekt.pdf}
\caption{AccordionGrad\_rekt.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/KumAcc_rekt_aar.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/mortalitet90_rektum_aar.pdf}
\caption{mortalitet90\_rektum\_aar.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{/home/rstudio/norgast/inst/fig_aarsrapp_2020/AvstandAnalVerge_kat_rekt.pdf}
