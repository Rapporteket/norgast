...
terskel <- 5
op_gruppe <- 4
RegDataAll$Robot <- RegDataAll$Robotassistanse
RegDataAll$Robot[is.na(RegDataAll$Robot)] <- 0
RegDataAll$Robot <- factor(RegDataAll$Robot, levels = 0:1, labels = c("Ikke-robot", "Robot"))
