...
outfile <- paste0(figfolder, 'mortalitet90_ventrikkel_aar_gruppertmalign.pdf')
valgtVar <- 'mortalitet90'
norgastIndikator_gruppert(
  RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width,
  height=height, decreasing=T, terskel=terskel, minstekrav = 8, maal = 5,
  ...
  graaUt=graaUt, inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra=datoFra,
  datoTil=datoTil, hastegrad_hybrid=1, malign=malign,
  kun_ferdigstilte = F, Grvar2 = "maligndiag", prikktall = FALSE, inkl_N = F,
  rotermaaltxt=90)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  norgastIndikator_gruppert(
    ...
    graaUt=graaUt, inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra=datoFra,
    datoTil=datoTil, hastegrad_hybrid=1, malign=malign,
    kun_ferdigstilte = F, Grvar2 = "maligndiag", prikktall = T,
    inkl_N = FALSE, rotermaaltxt=90)
}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}Tilgang_ventrikkel_aar_robot.pdf}
\caption{Tilgang\_ventrikkel\_aar\_robot.pdf}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}mortalitet90_ventrikkel_aar_gruppertmalign.pdf}
\caption{mortalitet90\_ventrikkel\_aar\_gruppertmalign.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}mortalitet90_ventrikkel_aar_gruppertrobot.pdf}
\caption{mortalitet90\_ventrikkel\_aar\_gruppertrobot.pdf}
\end{figure}
