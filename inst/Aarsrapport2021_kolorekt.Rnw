...
aux$Tilgang <- factor(aux$Tilgang, levels = 2:3, labels = c("\\quad Laparoskopisk", "\\quad Konvertert") )
...
alle under risiko.} & infeksjon & Blødning & Sårruptur & Annet & Ingen \\\\\n','\\midrule\n','\\bottomrule\n')), include.colnames=FALSE, include.rownames=FALSE, sanitize.text.function = function(x){x})
@
\captionof{table}{Kolonreseksjoner. Elektive operasjoner. Reoperasjoner \Sexpr{rap_aar} etter Robotassistanse. Gjelder \textbf{hele landet}.}
\end{minipage}
\end{table}
