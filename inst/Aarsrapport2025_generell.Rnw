...
DG <- readr::read_csv2(
  "C:/Users/kth200/regdata/norgast/aarsrapp2025/DGA_Norgast/Sykehus/Alle_sh.csv", locale = locale(encoding = "WINDOWS-1252")) |>
...
norgast::norgastAndelGruppert2Gr(valgtVar="Mort90", outfile = outfile,
                                 ...
                                 RegData = aux, datoFra=paste0(rap_aar, '-01-01'),
