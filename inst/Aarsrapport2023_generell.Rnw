...
outfile <- paste0(figfolder, outfile)
norgast::achocfigur2023rapport(valgtVar="Mort90", outfile = outfile,
...
outfile <- paste0(figfolder, outfile)
norgast::achocfigur2023rapport(valgtVar="KumAcc", outfile = outfile,
                               Grvar1 = "Op_gr", Grvar2 = "Tilgang_utvidet",
...
outfile <- paste0(figfolder, outfile)
norgast::achocfigur2023rapport(valgtVar="Malign", outfile = outfile,
                                 Grvar1 = "Op_gr", Grvar2 = "Tilgang_utvidet",
