...
dgterskel <- 70
# DG <- read.csv2('~/mydata/norgast/DG_Sykehus/Alle_sh.csv') %>%
...
annet_format_ut <- T
ut_format <- 'svg'
figfolder <- "C:/Users/kth200/register/norgast/resultater/aarsrapp2024/generell/"
if (!dir.exists(figfolder)) {
  dir.create(figfolder)
}
tabfolder <- "C:/Users/kth200/register/norgast/resultater/aarsrapp2024/generell/"
...
outfile <- 'Aktualitet_oppf_2022.pdf'
outfile <- paste0(figfolder, outfile)
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}Aktualitet_oppf_2022.pdf}
\caption{Aktualitet\_oppf\_2022.pdf}
\end{figure}

\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}Aktualitet_oppf_2023.pdf}
\caption{Aktualitet\_oppf\_2023.pdf}
\end{figure}
