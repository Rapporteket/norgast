...
\title{Figurer og tabeller for årsrapport NoRGast 2018}
\author{NoRGast}
...
shus_dg_under_60 <- function(filnavn_dg, arknavn) {
  DG_alle <- xlsx::read.xlsx(filnavn_dg, sheetName = arknavn, encoding = 'UTF-8', stringsAsFactors=FALSE)
  names(DG_alle) <- c('Sykehus', 'NoRGast.N', 'NPR.N', 'DG.NoRGast')
  DG_alle$DG.NoRGast <- as.numeric(DG_alle$DG.NoRGast)
  DG_alle$Sykehus <- trimws(DG_alle$Sykehus)
  DG_alle$Sykehus <- gsub(' ', '', DG_alle$Sykehus)
  DG_alle$Sykehus[DG_alle$Sykehus == 'HS-MoiRana'] <- "HS-Mo i Rana"
  DG_alle <- DG_alle[-which(DG_alle$Sykehus=='Totalt'), ]
  shus <- DG_alle$Sykehus[which(DG_alle$DG.NoRGast < 60)]
}

graaUt_alle <- shus_dg_under_60(filnavn_dg='C:/GIT/norgast/doc/DG_norgast_2018.xlsx', arknavn='Totalt')
graaUt_kolon <- shus_dg_under_60(filnavn_dg='C:/GIT/norgast/doc/DG_norgast_2018.xlsx', arknavn='Kolon')
graaUt_lever <- shus_dg_under_60(filnavn_dg='C:/GIT/norgast/doc/DG_norgast_2018.xlsx', arknavn='Lever')
graaUt_pankreas <- shus_dg_under_60(filnavn_dg='C:/GIT/norgast/doc/DG_norgast_2018.xlsx', arknavn='Pankreas')
graaUt_rektum <- shus_dg_under_60(filnavn_dg='C:/GIT/norgast/doc/DG_norgast_2018.xlsx', arknavn='Rektum')
graaUt_ventrikkel <- shus_dg_under_60(filnavn_dg='C:/GIT/norgast/doc/DG_norgast_2018.xlsx', arknavn='Ventrikkel')
graaUt_osofagus <- shus_dg_under_60(filnavn_dg='C:/GIT/norgast/doc/DG_norgast_2018.xlsx', arknavn='Osofagus')
...
norgastIndikatorLinn(RegDataAll[RegDataAll$Op_gr %in% 1:7, ], valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
                     ...
                     inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra=datoFra, datoTil=datoTil, elektiv=1, malign=malign, lavDG = graaUt_alle)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  norgastIndikatorLinn(RegDataAll[RegDataAll$Op_gr %in% 1:7, ], valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
                     decreasing=decreasing, terskel=terskel, minstekrav = 80, maal = 90, skriftStr=skriftStr,
...
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{Saarruptur_alle.pdf}
% \caption{}
% \end{figure}
...
Terskel<-20
TabellData_landet <- NorgastTabeller(RegData=RegData[which(RegData$Hastegrad_tid==1), ], datoFra=datoFra, datoTil=datoTil,
...
FigAndeler(RegDataAll, valgtVar='ViktigsteFunn', outfile=outfile, datoFra='2018-01-01', datoTil=datoTil, reshID=reshID,
           enhetsUtvalg=0, op_gruppe=op_gruppe, elektiv=elektiv)

tittel <- ''
outfile <- 'Tilgang_elektiv_benign.pdf'
malign <- 0

NorgastFigAndelStabelGrVar(RegData, valgtVar='Tilgang', op_gruppe=op_gruppe, elektiv=elektiv, outfile=outfile, Ngrense=10, malign = malign, lavDG = graaUt_kolon)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegData, valgtVar='Tilgang', op_gruppe=op_gruppe, elektiv=elektiv, outfile=outfile, Ngrense=10, malign = malign, lavDG = graaUt_kolon)
}
...
FigAndeler(RegData, valgtVar='Tilgang', enhetsUtvalg=0, op_gruppe=op_gruppe, elektiv=0, outfile=outfile, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  FigAndeler(RegData, valgtVar='Tilgang', enhetsUtvalg=0, op_gruppe=op_gruppe, elektiv=0, outfile=outfile, reshID=reshID)
}
...
NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='AccordionGrad', op_gruppe=op_gruppe, elektiv=1, outfile=outfile, Ngrense=10, malign = malign,
                           datoFra = '2016-01-01', datoTil = '2018-12-31', lavDG = graaUt_kolon)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='AccordionGrad', op_gruppe=op_gruppe, elektiv=1, outfile=outfile, Ngrense=10, malign = malign,
                             datoFra = '2016-01-01', datoTil = '2018-12-31', lavDG = graaUt_kolon)
...
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegData, valgtVar='AccordionGrad', op_gruppe=op_gruppe, elektiv=1, outfile=outfile, Ngrense=10, malign = malign,
                             datoFra = '2016-01-01', datoTil = '2018-12-31', lavDG = graaUt_kolon)
}
...
FigAndeler(RegData, valgtVar='AccordionGrad', enhetsUtvalg=0, op_gruppe=op_gruppe, elektiv=0, outfile=outfile, reshID=reshID)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  FigAndeler(RegData, valgtVar='AccordionGrad', enhetsUtvalg=0, op_gruppe=op_gruppe, elektiv=0, outfile=outfile, reshID=reshID)
}
...
norgastIndikatorLinn(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
                        ...
                        inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra=datoFra, datoTil=datoTil, elektiv=99, malign=99)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  norgastIndikatorLinn(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
                        decreasing=T, terskel=terskel, minstekrav = NA, maal = NA, skriftStr=skriftStr,
...
NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_rektum)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_rektum)
}
...
NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_rektum)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_rektum)
}
...
norgastIndikatorLinn(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
                        ...
                        inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra=datoFra, datoTil=datoTil, elektiv=1, malign=1)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  norgastIndikatorLinn(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
                        decreasing=decreasing, terskel=terskel, minstekrav = 60, maal = 70, skriftStr=skriftStr, lavDG = graaUt_rektum,
...
NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_osofagus)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_osofagus)
}
...
NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_osofagus)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_osofagus)
}
...
NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='ThoraxTilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_osofagus)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='ThoraxTilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_osofagus)
}
...
#                         pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt,
#                         inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra=datoFra, datoTil=datoTil, elektiv=1, malign=malign)
# if (annet_format_ut) {
#   outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
#   norgastIndikatorLinn(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
#                         decreasing=T, terskel=terskel, minstekrav = minstekrav, maal = maal, skriftStr=skriftStr,
...
NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_ventrikkel)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_ventrikkel)
}
...
NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_ventrikkel)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_ventrikkel)
}
...
NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_lever)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_lever)
}
...
NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_lever)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_lever)
}
...
NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_pankreas)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='AccordionGrad', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_pankreas)
}
...
NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_pankreas)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegDataAll, valgtVar='Tilgang', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, datoFra='2018-01-01', lavDG = graaUt_pankreas)
}
