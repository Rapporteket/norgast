...
\title{Figurer og tabeller for årsrapport NoRGast 2021 - Lever og pankreas}
\author{NoRGast}
...
NorgastFigAndelStabelGrVar(RegData, valgtVar='AccordionGrad_drenasje', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, lavDG = graaUt_lever)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegData, valgtVar='AccordionGrad_drenasje', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, lavDG = graaUt_lever)
}

outfile <- figfolder %>% paste0('AccordionGrad_lever_aar.pdf')
valgtVar <- 'KumAcc'
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}AccordionGrad_lever_aar.pdf}
\caption{AccordionGrad\_lever\_aar.pdf}
\end{figure}
...
NorgastFigAndelStabelGrVar(RegData, valgtVar='AccordionGrad_drenasje', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, lavDG = graaUt_pankreas)
if (annet_format_ut) {
  outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
  NorgastFigAndelStabelGrVar(RegData, valgtVar='AccordionGrad_drenasje', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, lavDG = graaUt_pankreas)
}

outfile <- figfolder %>% paste0('AccordionGrad_whipple_aar.pdf')
valgtVar <- 'KumAcc'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
                     decreasing=decreasing, terskel=terskel, minstekrav = minstekrav, maal = maal, skriftStr=skriftStr,
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}AccordionGrad_whipple_aar.pdf}
\caption{AccordionGrad\_whipple\_aar.pdf}
\end{figure}
...
outfile <- figfolder %>% paste0('AccordionGrad_ovrigpankreas_aar.pdf')
valgtVar <- 'KumAcc'
norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
                     decreasing=decreasing, terskel=terskel, minstekrav = minstekrav, maal = maal, skriftStr=skriftStr,
                     pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt, lavDG = graaUt_pankreas,
...
\begin{figure}[ht]
\centering
\includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}AccordionGrad_ovrigpankreas_aar.pdf}
\caption{AccordionGrad\_ovrigpankreas\_aar.pdf}
\end{figure}
...
% %% ######### Malign pankreas
%
% \section{Whipples operasjon - malign}
%
%
% \begin{table}[htb]
% \begin{minipage}{\textwidth}
% \centering
% <<'Tabell:ReoperasjonerWhipple_malign', results='asis', echo=FALSE, eval=T, warning=FALSE>>=
% Terskel<-20
%
% TabellData_landet <- NorgastTabeller(RegData=RegData[which(RegData$Malign==1), ], datoFra=datoFra, datoTil=datoTil,
%                                      minald=0, maxald=130, erMann=99, enhetsUtvalg=0, Terskel=Terskel, reshID=reshID)
% Tabell <- TabellData_landet$Tabell2
% Tabell <- Tabell[c(6), ]
% write.csv2(Tabell, 'C:/GIT/norgast/inst/tabeller/reop_whipple_malign.csv', row.names = F, fileEncoding = 'Latin1')
% print(xtable::xtable(Tabell, digits=c(0,0,0,rep(1, ncol(Tabell)-2))),
%       floating=FALSE,
%       hline.after=NULL,
%       align=c('l', 'l', rep('r', ncol(Tabell)-1)),
...
% alle under risiko.} & infeksjon & Blødning & Sårruptur & Annet & Ingen \\\\\n','\\midrule\n','\\bottomrule\n')), include.colnames=FALSE, include.rownames=FALSE)
% @
%   \captionof{table}{Whipples operasjon. Malign. Reoperasjoner \Sexpr{rap_aar}. Gjelder \textbf{hele landet}.}
% \end{minipage}
% \end{table}
%
%
% <<'fig_whipple_malign', include=FALSE, echo=FALSE, eval=T, cache=FALSE>>=
%   # reseksjonsGr <- 'JLC30|JLC31'
%   op_gruppe <- 6
% malign <- 1
%
% outfile <- figfolder %>% paste0('Rekonstruksjon_whipple_aar_malign.pdf')
% valgtVar <- 'Rekonstruksjon'
% norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
%                      decreasing=decreasing, terskel=terskel, minstekrav = minstekrav, maal = maal, skriftStr=skriftStr,
%                      pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt, lavDG = graaUt_pankreas, lavDGtekst = 'Dekningsgrad < 55 %',
...
% }
%
% outfile <- figfolder %>% paste0('CR_POPF_whipple_aar_malign.pdf')
% valgtVar <- 'CR_POPF'
% norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
%                      decreasing=decreasing, terskel=terskel, minstekrav = 20, maal = 15, skriftStr=skriftStr,
%                      pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt, lavDG = graaUt_pankreas, lavDGtekst = 'Dekningsgrad < 55 %',
...
%
%
% outfile <- figfolder %>% paste0('ReLapNarkose_whipple_malign.pdf')
% valgtVar <- 'ReLapNarkose'
% norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
%                      decreasing=T, terskel=terskel, minstekrav = minstekrav, maal = 20, skriftStr=skriftStr,
%                      pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt, lavDG = graaUt_pankreas, lavDGtekst = 'Dekningsgrad < 55 %',
...
% }
%
% outfile <- figfolder %>% paste0('mortalitet90_whipple_aar_malign.pdf')
% valgtVar <- 'mortalitet90'
% norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
%                      decreasing=T, terskel=terskel, minstekrav = 8, maal = 5, skriftStr=skriftStr,
%                      pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt, lavDG = graaUt_pankreas, lavDGtekst = 'Dekningsgrad < 55 %',
...
%                        inkl_konf=inkl_konf, op_gruppe=op_gruppe, datoFra=datoFra, datoTil=datoTil, hastegrad_hybrid=hastegrad_hybrid, malign=malign)}
%
% outfile <- figfolder %>% paste0('AccordionGrad_whipple_malign.pdf')
% NorgastFigAndelStabelGrVar(RegData, valgtVar='AccordionGrad_drenasje', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, lavDG = graaUt_pankreas, malign = malign)
% if (annet_format_ut) {
%   outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
%   NorgastFigAndelStabelGrVar(RegData, valgtVar='AccordionGrad_drenasje', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, lavDG = graaUt_pankreas, malign = malign)
% }
%
% outfile <- figfolder %>% paste0('AccordionGrad_whipple_aar_malign.pdf')
% valgtVar <- 'KumAcc'
% norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
%                      decreasing=decreasing, terskel=terskel, minstekrav = minstekrav, maal = maal, skriftStr=skriftStr,
%                      pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt, lavDG = graaUt_pankreas,
...
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}Rekonstruksjon_whipple_aar_malign.pdf}
% \caption{Rekonstruksjon\_whipple\_aar\_malign.pdf}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}ReLapNarkose_whipple_malign.pdf}
% \caption{ReLapNarkose\_whipple\_malign.pdf}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}AccordionGrad_whipple_malign.pdf}
% \caption{AccordionGrad\_whipple\_malign.pdf}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}AccordionGrad_whipple_aar_malign.pdf}
% \caption{AccordionGrad\_whipple\_aar\_malign.pdf}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}mortalitet90_whipple_aar_malign.pdf}
% \caption{mortalitet90\_whipple\_aar\_malign.pdf}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}CR_POPF_whipple_aar_malign.pdf}
% \caption{CR\_POPF\_whipple\_aar\_malign.pdf}
% \end{figure}
%
% \clearpage
%
% \section{Øvrige pankreasreseksjoner - malign}
%
% % \addtolength{\hoffset}{-1.5cm}
%
% \begin{table}[htb]
% \begin{minipage}{\textwidth}
% \centering
% <<'Tabell:ReoperasjonerPankreas_malign', results='asis', echo=FALSE, eval=T, warning=FALSE>>=
%   Terskel<-20
% TabellData_landet <- NorgastTabeller(RegData=RegData[which(RegData$Malign==1), ], datoFra=datoFra, datoTil=datoTil,
%                                      minald=0, maxald=130, erMann=99, enhetsUtvalg=0, Terskel=Terskel, reshID=reshID)
% Tabell <- TabellData_landet$Tabell2
...
% alle under risiko.} & infeksjon & Blødning & Sårruptur & Annet & Ingen \\\\\n','\\midrule\n','\\bottomrule\n')), include.colnames=FALSE, include.rownames=FALSE)
% @
%   \captionof{table}{Øvrige pankreasreseksjoner. Malign. Reoperasjoner \Sexpr{rap_aar}. Gjelder \textbf{hele landet}.}
% \end{minipage}
% \end{table}
%
%
% <<'fig_ovrigpankreas_malign', include=FALSE, echo=FALSE, eval=T, cache=FALSE>>=
%   op_gruppe <- 7
%
% outfile <- figfolder %>% paste0('Tilgang_ovrigpankreas_aar_malign.pdf')
% valgtVar <- 'LapTilgang2'
% norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
%                      decreasing=decreasing, terskel=terskel, minstekrav = minstekrav, maal = 35, skriftStr=skriftStr,
%                      pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt, lavDG = graaUt_pankreas, lavDGtekst = 'Dekningsgrad < 55 %',
...
% }
%
% outfile <- figfolder %>% paste0('Rekonstruksjon_ovrigpankreas_aar_malign.pdf')
% valgtVar <- 'Rekonstruksjon'
% norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
%                      decreasing=decreasing, terskel=terskel, minstekrav = minstekrav, maal = maal, skriftStr=skriftStr,
%                      pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt, lavDG = graaUt_pankreas, lavDGtekst = 'Dekningsgrad < 55 %',
...
% }
%
% outfile <- figfolder %>% paste0('CR_POPF_ovrigpankreas_aar_malign.pdf')
% valgtVar <- 'CR_POPF'
% norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
%                      decreasing=decreasing, terskel=terskel, minstekrav = 20, maal = 15, skriftStr=skriftStr,
%                      pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt, lavDG = graaUt_pankreas, lavDGtekst = 'Dekningsgrad < 55 %',
...
%
%
% outfile <- figfolder %>% paste0('AccordionGrad_ovrigpankreas_malign.pdf')
% NorgastFigAndelStabelGrVar(RegData, valgtVar='AccordionGrad_drenasje', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, lavDG = graaUt_pankreas, malign = malign)
% if (annet_format_ut) {
%   outfile <- paste0(substr(outfile, 1, nchar(outfile)-3), ut_format)
%   NorgastFigAndelStabelGrVar(RegData, valgtVar='AccordionGrad_drenasje', op_gruppe=op_gruppe, outfile=outfile, Ngrense=terskel, lavDG = graaUt_pankreas, malign = malign)
% }
%
% outfile <- figfolder %>% paste0('AccordionGrad_ovrigpankreas_aar_malign.pdf')
% valgtVar <- 'KumAcc'
% norgastIndikator_rapporteket(RegDataAll, valgtVar = valgtVar, outfile=outfile, tittel=tittel, width=width, height=height,
%                      decreasing=decreasing, terskel=terskel, minstekrav = minstekrav, maal = maal, skriftStr=skriftStr,
%                      pktStr=pktStr, legPlass=legPlass, minstekravTxt=minstekravTxt, maalTxt=maalTxt, graaUt=graaUt, lavDG = graaUt_pankreas,
...
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}Tilgang_ovrigpankreas_aar_malign.pdf}
% \caption{Tilgang\_ovrigpankreas\_aar\_malign.pdf}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}Rekonstruksjon_ovrigpankreas_aar_malign.pdf}
% \caption{Rekonstruksjon\_ovrigpankreas\_aar\_malign.pdf}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}CR_POPF_ovrigpankreas_aar_malign.pdf}
% \caption{CR\_POPF\_ovrigpankreas\_aar\_malign.pdf}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}AccordionGrad_ovrigpankreas_malign.pdf}
% \caption{AccordionGrad\_ovrigpankreas\_malign.pdf}
% \end{figure}
%
% \begin{figure}[ht]
% \centering
% \includegraphics[width=\Sexpr{figstr}\textwidth]{\Sexpr{figfolder}AccordionGrad_ovrigpankreas_aar_malign.pdf}
% \caption{AccordionGrad\_ovrigpankreas\_aar\_malign.pdf}
% \end{figure}
%
%
