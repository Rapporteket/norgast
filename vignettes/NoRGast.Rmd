...
* `DoedsDato` - Dødsdato i R datoformat (POSIXlt) basert på `DECEASED_DATE`
...
* `RELAPAROTOMY` - Settes lik 1 hvis `RELAPAROTOMY` eller `READMISSION_RELAPAROTOMY` er lik 1.
* `RELAPAROTOMY_YES` - Settes til minimum av `RELAPAROTOMY_YES` og `READMISSION_RELAPAROTOMY_YES`, dvs. den mest alvorlige komplikasjonen.
